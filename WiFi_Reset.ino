...
void loop()
{
  ...
  //watchdogCounter = 0;   //Uncomment to "feed" the watchdog.  Uncommented Watchdog triggers every 60 seconds.
                           //Commented out watchfog is only triggered by an interrupt; like opening FTP.
}
